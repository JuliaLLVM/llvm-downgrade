...
void ModuleBitcodeWriter50::writeTypeTable() {
  ...
  for (unsigned i = 0, e = TypeList.size(); i != e; ++i) {
    ...
    case Type::ScalableVectorTyID:
      llvm_unreachable("scalar vector types are not supported with LLVM 5.0");
      break;
    case Type::BFloatTyID:
      llvm_unreachable("bfloat16 type is not supported with LLVM 5.0");
      break;
    case Type::X86_AMXTyID:
      llvm_unreachable("AMX types are not supported with LLVM 5.0");
      break;
